...
def algorithm(I,d,K,h,iterations, tau, function,domain,scaling, alpha, beta):
...
NN = algorithm(I,d,K,h,iterations, tau, test_function1,domain,scaling, alpha, beta)
...
NN = algorithm(I,d,K,h,iterations,tau, test_function2,domain, scaling, alpha, beta)
...
NN = algorithm(I,d,K,h,iterations, tau, test_function3,domain,scaling,alpha,beta)
